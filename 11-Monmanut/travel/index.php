            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        <span class="home__data-subtitle">Bliss accompanied by a gentle rumble...</span>
                        <h1 class="home__data-title">A paradise <br>for all things fluffy</h1>
                    ...
                    <div class="home__info">
                        <div>
                            <span class="home__info-title">The Three Most Beloved/Adored</span>
                        ...
                        <div class="home__info-overlay">
                            <img src="assets/img/c4.webp" alt="" class="home__info-img">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="about section" id="about">
                <div class="about__container container grid">
                    <div class="about__data">
                        ...
                        <p class="about__description">Relax with our adorable companions and savor our delicious special menu. 
                            Don't wait—reserve your table now!
                        </p>
                    ...
                    <div class="about__img">
                        <div class="about__img-overlay">
                            <img src="assets/img/c6.jpg" alt="" class="about__img-one">
                        </div>

                        <div class="about__img-overlay">
                            <img src="assets/img/g2.jpg" alt="" class="about__img-two">
                        </div>
                    </div>
                </div>
            </section>
